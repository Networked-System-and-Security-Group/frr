...
static void test_shared_address_three_nodes(void)
{
	...
	struct midr_transport_endpoint b_ep =
		transport_endpoint(MIDR_TRANSPORT_AF_IPV4, test_port(11));
	struct midr_transport_endpoint c_ep =
		transport_endpoint(MIDR_TRANSPORT_AF_IPV4, test_port(12));
	unsigned int a_est, b_est, c_est;

	side_create(&a, 601, MIDR_TRANSPORT_AF_IPV4, test_port(10));
	side_create(&b, 602, MIDR_TRANSPORT_AF_IPV4, test_port(11));
	side_create(&c, 603, MIDR_TRANSPORT_AF_IPV4, test_port(12));
