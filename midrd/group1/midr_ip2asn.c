...
DEFINE_MTYPE_STATIC(MIDR_G1, MIDR_IP2ASN_VALUE, "MIDR IP-to-ASN value");
DEFINE_MTYPE_STATIC(MIDR_G1, MIDR_IP2ASN_PATH, "MIDR IP-to-ASN path");
DEFINE_MTYPE_STATIC(MIDR_G1, MIDR_IP2ASN_UPDATE,
