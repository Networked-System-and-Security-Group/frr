...
#include "midrd/group1/midr_trace_engine.h"
...
DEFINE_MTYPE_STATIC(MIDR_G1, MIDR_TRACE_SCHEDULER, "MIDR traceroute scheduler");
DEFINE_MTYPE_STATIC(MIDR_G1, MIDR_TRACE_JOB, "MIDR traceroute job");
DEFINE_MTYPE_STATIC(MIDR_G1, MIDR_TRACE_REQUEST, "MIDR traceroute request");
DEFINE_MTYPE_STATIC(MIDR_G1, MIDR_TRACE_CACHE, "MIDR traceroute cache entry");
DEFINE_MTYPE_STATIC(MIDR_G1, MIDR_TRACE_HISTORY, "MIDR traceroute history entry");
