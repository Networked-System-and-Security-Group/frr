...
# organic-growth test. Star topology via ns-gr-hub, 4 nodes: one rep (r) and
# three sequential joiners (j1, j2, j3). Uses its own namespace prefix
...
declare -A HUBIP=( [r]=10.20.1.1  [j1]=10.20.2.1  [j2]=10.20.3.1  [j3]=10.20.4.1 )
declare -A NODEIP=( [r]=10.20.1.2 [j1]=10.20.2.2 [j2]=10.20.3.2 [j3]=10.20.4.2 )
